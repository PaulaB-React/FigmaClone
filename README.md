<div align="center">
  ...
  <h3 align="center">Real Time Figma Clone</h3>
   ...
   <div align="center">
     Project build uising a full of bugs tutorial on <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a> YouTube.
    </div>
</div>
...
```bash
git clone git@github.com:PaulaB-React/FigmaClone.git
cd FigmaClone
```
